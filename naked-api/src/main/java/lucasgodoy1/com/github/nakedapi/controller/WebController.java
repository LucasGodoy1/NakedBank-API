...
public class WebController {
    ...
    public ResponseEntity<Cliente> adicionandoDados(@PathVariable Long id, @RequestBody Cliente d) {
        Usuario u = usuarioService.encontrePorID(id);
    ...
    public ResponseEntity<Cliente> dadosInfo(@PathVariable Long id) {
        Cliente u = dadosPessoaisService.encontrePorID(id);
        return ResponseEntity.status(HttpStatus.OK).body(u);
    }

    @DeleteMapping("/deleteInfoPorID={id}")
    public ResponseEntity<Cliente> deleteInPorID(@PathVariable Long id) {
